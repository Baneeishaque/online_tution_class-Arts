...
//    var_dump($_POST);
    ...
    $student_login_sql = "SELECT `teacher_id`, `full_name`, `mobile_number`, `email_address`, `teaching_class`, `status`, `username`, `password` FROM `teachers` WHERE `username`='$username' AND `passowrd`='$password'";
