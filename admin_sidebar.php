...
function print_sidebar($main_section, $sub_section)
{
    ...
    echo '><a href="admin_students.php">Current Students</a></li>
                        <li ';
    ...
    echo '><a href="admin_home.php">Unverified Students</a></li>
                        <li ';
    ...
    echo '><a href="suspended_students.php">Suspended Students</a></li>
                        <li ';
    ...
    echo '><a href="add_student.php">Add Students</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a ';
    ...
    echo '><a href="admin_courses.php">All Courses</a></li>
                        <li ';
    ...
    echo '><a href="admin_streams.php">All Streams</a></li>
                        <li ';
