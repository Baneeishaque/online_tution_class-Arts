...
$student_fetch_sql = "SELECT `student_id`, `full_name`, `mobile_number`, `email_address`, `studying_class`, `status`, `username`, `password` FROM `students` WHERE `status` = 0";
...
<head>
    ...
    <title>DASHGUM - Admin Home</title>
...
<section id="container">
    ...
    *********************************************************************************************************************************************************** -->
    ...
    <header class="header black-bg">
        ...
        <!--logo start-->
        <a class="logo" href="index_backup.html"><b>DASHGUM</b></a>
        <!--logo end-->
        ...
        <!-- settings start -->
        <!--                    <li class="dropdown">-->
        <!--                        <a class="dropdown-toggle" data-toggle="dropdown" href="index_backup.html#">-->
        ...
        <!--                            </li>-->
        <!--                            <li>-->
        <!--                                <a href="index_backup.html#">See all messages</a>-->
        <!--                            </li>-->
        <!--                        </ul>-->
        <!--                    </li>-->
        <!-- inbox dropdown end -->
        ...
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="#">Unverified Teachers</a></li>
                    ...
                    <div class="content-panel">
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <tr>
                                ...
                                <th class="hidden-phone"><i class="fa fa-question-circle"></i> Studying Class</th>
                            ...
                            while ($student_fetch_query_result_row = mysqli_fetch_assoc($student_fetch_query_result)) {
                                ...
                                <td>' . $student_fetch_query_result_row['studying_class'] . '</td>
