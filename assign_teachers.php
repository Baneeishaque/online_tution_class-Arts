...
<section id="container">
    ...
    print_sidebar("Teachers", "Assign Teachers");
    ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control" name="teacher-id">
                                        ...
                                        $subject_fetch_sql = "SELECT `teacher_id`, `full_name`, `mobile_number`, `email_address`, `teaching_class`, `status`, `username`, `password` FROM `teachers`";
